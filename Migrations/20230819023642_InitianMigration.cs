        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VehiculoNombre = table.Column<string>(type: "TEXT", nullable: false),
                    VehiculoApellido = table.Column<string>(type: "TEXT", nullable: false),
                    VehiculoTipo = table.Column<string>(type: "TEXT", nullable: false),
                    VehiculoMatricula = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PilotoId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    PilotoNombre = table.Column<string>(type: "TEXT", maxLength: 30, nullable: false),
                    PilotoApellido = table.Column<string>(type: "TEXT", maxLength: 30, nullable: false),
